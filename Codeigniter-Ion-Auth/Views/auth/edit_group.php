...
<head>
  ...
  <title><?php echo lang('Auth.edit_group_heading');?></title>
  ...
  <div class="container" id="formcontainer" style="display:none;">
    <div class="row">
      <div class="col-lg-5 col-md-6 col-sm-8 col-10 mx-auto">
        <h1 class="mt-5 text-center"><?php echo lang('Auth.edit_group_heading');?></h1>
            <p class="text-center"><?php echo lang('Auth.edit_group_subheading');?></p>
            <br>
