...
<head>
  ...
  <title><?php echo lang('Auth.forgot_password_heading');?></title>
  ...
  <div class="container" id="formcontainer" style="display:none;">
    <div class="row">
      <div class="col-lg-4 col-md-6 col-sm-8 col-10 mx-auto">
        <h1 class="mt-5 text-center"><?php echo lang('Auth.forgot_password_heading');?></h1>
            <p class="text-center"><?php echo sprintf(lang('Auth.forgot_password_subheading'), $identity_label);?></p>
            <br>
            ...
            <?php echo form_open('auth/forgot_password');?>
                  ...
                  <div class="form-group text-right">
                      <?php echo form_submit('submit', lang('Auth.forgot_password_submit_btn'));?>
                  </div>
